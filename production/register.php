                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Bonjour,</p>
                        <p>Un nouveau utilisateur`.$Nutilisateur.`possesseur de d'addresse Email`.$mailUtilisateur.` a voulu créer un compte sur la plateform , veuillez le confirmer</p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="C:\wamp64\www\ecrmanager\production\Abasedd.php?username=`.$Nutilisateur.`&mdp=`.$mdp.`&username=`.$mailUtilisateur.`" target="_blank">Confirmer</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>Si l'utilisateur est indésirable veuillez verifier les postes de votre équipe. Un intrus a eu accès au plateform ! </p>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Z.I. Rue des Metaux, Ben Arous 2013</span>
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by ECR Manager
                  </td>
                </tr>
              </table>
            </div>
